const AaveOracle = {
  address: { 5: '0x9F616c65b5298E24e155E4486e114516BC635b63' },
  abi: [
    {
      inputs: [
    ...
    { inputs: [], name: 'getFallbackOracle', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
    {
      inputs: [{ internalType: 'address', name: 'asset', type: 'address' }],
    ...
    { inputs: [{ internalType: 'address', name: 'fallbackOracle', type: 'address' }], name: 'setFallbackOracle', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  ],
};
export default AaveOracle;
