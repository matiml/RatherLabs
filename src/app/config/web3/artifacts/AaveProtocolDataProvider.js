const AaveProtocolDataProvider = {
  address: { 5: '0xa41E284482F9923E265832bE59627d91432da76C' },
  abi: [
    ...
    { inputs: [], name: 'getDebtCeilingDecimals', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'pure', type: 'function' },
    {
      inputs: [{ internalType: 'address', name: 'asset', type: 'address' }],
...
export default AaveProtocolDataProvider;
